...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="flex flex-col items-center justify-center text-center"> <!-- Título principal --> <header class="relative w-full"> <div class="relative h-80 sm:h-[28rem] w-full bg-center bg-cover bg-no-repeat" style="background-image: url('/img/fotoParejaPrincipal.jpg')"> <!-- Fondo oscuro opcional para contraste --> <!-- <div class="absolute inset-0 bg-black/30 z-0"></div> --> <!-- Olas invertidas --> ${renderComponent($$result, "SmoothWaves", $$SmoothWaves, { "className": "absolute bottom-0 left-0 w-full text-background rotate-180" })} <!-- Texto centrado en Y y a la izquierda en X --> <div class="absolute top-1/2 left-10 -translate-y-1/2 z-10 text-white font-bold"> <h1 class="text-4xl sm:text-7xl md:text-8xl font-greatVibes">
Daniela
</h1> <h1 class="text-xl sm:text-2xl md:text-3xl font-baskerbille">&</h1> <h1 class="text-4xl sm:text-7xl md:text-8xl font-greatVibes">Alex</h1> </div> </div> </header> <!-- Mensaje de bienvenida --> <div class="mt-8 max-w-3xl px-4"> <h2 class="text-3xl sm:text-4xl mb-4 font-baskerbille">¡Nos Casamos!</h2> <p class="text-xl leading-relaxed">
...
PADRES DE LA NOVIA
</h2> <p class="text-center text-xl">Roberto Estrada</p> <p class="text-center text-xl">Elena Villarreal</p> </div> <!-- Padres del Novio --> <div> <h2 class="text-2xl mb-4 text-center text-primary">PADRES DEL NOVIO</h2> <p class="text-center text-xl">Ricardo Méndez</p> <p class="text-center text-xl">Beatriz Soler</p> </div> </div> </div> </section>`;
...
09
</p> <p class="text-2xl sm:text-3xl text-black self-center">AGOSTO</p> </div> <p class="mt-4 text-lg sm:text-xl text-black font-bold">Lambayeque 2026</p> </div> <!-- Reloj contador --> <div id="timer" class="flex flex-wrap justify-center gap-4 sm:gap-6 text-black text-4xl sm:text-5xl md:text-6xl border-y-2 border-black py-4 w-fit mx-auto"> <div class="flex flex-col items-center"> <span id="days">00</span> <span class="text-sm sm:text-base">D\xEDas</span> </div> <div class="flex flex-col items-center"> <span id="hours">00</span> <span class="text-sm sm:text-base">Horas</span> </div> <div class="flex flex-col items-center"> <span id="minutes">00</span> <span class="text-sm sm:text-base">Minutos</span> </div> <div class="flex flex-col items-center"> <span id="seconds">00</span> <span class="text-sm sm:text-base">Segundos</span> </div> </div> <div class="text-center px-4 pt-10 flex flex-col items-center gap-4 max-w-xl mx-auto"> <img src="/img/selloViaje.svg" alt="Br\xFAjula giratoria" class="w-24 sm:w-28 md:w-32 h-auto"> <p class="text-base sm:text-lg leading-relaxed">
Deseamos celebrar nuestra boda con su compa\xF1\xEDa y es por eso que nos
      complace invitarles a nuestra boda.
...
const $$MapSuit = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="relative flex justify-center"> <div class="px-5 py-10 max-w-5xl w-full"> <div class="grid grid-cols-1 md:grid-cols-2 gap-10"> <!-- Escala --> <div class="flex flex-col items-center text-center gap-3"> <img src="/img/map.png" alt="Ubicación" class="w-24 sm:w-28 md:w-32 h-auto"> <h2 class="text-5xl sm:text-6xl mb-2 text-primary font-greatVibes">
Arribo
</h2> <p class="text-xl">Salón Residencial ABC</p> <p class="text-xl">15:00 h</p> <a href="#" target="_blank" class="mt-2 inline-block bg-primary text-white px-5 py-2 rounded-full shadow hover:bg-primary/90 transition">
Ver en Google Maps
</a> </div> <!-- Vestimenta --> <div class="flex flex-col items-center text-center gap-3"> <img src="/img/suit.png" alt="Vestimenta" class="w-24 sm:w-28 md:w-32 h-auto"> <h2 class="text-5xl sm:text-6xl mb-2 text-primary font-greatVibes">
Vestimenta
</h2> <div> <h3 class="text-xl font-bold">Mujeres</h3> <p class="text-xl">Vestido</p> <p class="text-xl">Ni un color parecido al blanco</p> <h3 class="text-xl font-bold">Hombres</h3> <p class="text-xl">Traje/sport Elegante</p> </div> </div> </div> </div> </section>`;
...
El regalo es opcional, tu presencia obligatoria pero si deseas tener un
      detalle con nostros te dejamos nuestra cuenta bancaria y nuestro QR <span class="block font-bold">¿Te unes?</span> </p> <img src="/img/qr-sample.png" class="mx-auto p-5 border h-60" alt="qr"> <p class="mt-3">Cuenta BCP: 123456789</p> <p>CCI: 0024122345678907</p> </div> <!-- Ola inferior --> <div class="absolute bottom-0 left-0 w-full leading-[0] text-primary"> ${renderComponent($$result, "WaveBottom", $$WaveBottom, {})} </div> </section>`;
...
Check In
</h2> <p class="text-xl">NO OLVIDES CONFIRMAR TU ASISTENCIA</p> <a href="https://www.google.com" target="_blank" class="bg-primary text-background py-2 px-6 border rounded-full transform hover:scale-110 transition duration-300">
...
</p> <!-- Botón de compartir --> <a href="#" class="bg-background text-primary py-2 px-6 border rounded-full transform animate-pulse hover:scale-105 transition duration-300" target="_blank">
